...
const UndergradContent = ({ blok }) => {
    return (
        <div
            ...
            <div className="relative aspect-[7/4] w-full max-w-[600px] rounded-lg md:shadow-2xl lg:order-first lg:justify-self-end">
                <img
            ...
            <div className="flex flex-col gap-2 md:gap-4 lg:gap-6 lg:max-w-[600px]">
